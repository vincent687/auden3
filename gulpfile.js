  ...
  pump(
    [
      src([
        ...
        npm_src   + '@glidejs/glide/dist/glide.min.js',
        npm_src   + 'body-scroll-lock/lib/bodyScrollLock.min.js',
...
// Disable build icons as we directly modify the generated icon file
